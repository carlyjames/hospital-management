    ...
    <section className='flex items-center justify-center h-screen gap-4 relative'>
      <div className=' items-end bg-login h-[92vh] w-[65%] bg-cover bg-center rounded-lg shadow-lg lg:flex hidden'>
        <div className='flex flex-col gap-3 p-4'>
          ...
          <p className='text-xl font-light text-gray-400'>Register to start managing patients and medical <br /> records efficiently.</p>
        </div>
      </div>
      <div className='flex flex-col gap-2 bg-white p-4 pb-2 rounded-lg shadow-lg lg:w-[30%] w-full h-[85vh] transform lg:-translate-x-20'>
        ...
        <div className='flex flex-col gap-2'>
            <Button className='flex items-center justify-around cursor-pointer bg-white border border-gray-200 text-gray-500 hover:bg-gray-100 w-full'>Sign up with Google</Button>
            <Button className='flex items-center justify-around cursor-pointer bg-white border border-gray-200 text-gray-500 hover:bg-gray-100 w-full'>Sign up with Facebook</Button>
            <Button className='flex items-center justify-around cursor-pointer bg-white border border-gray-200 text-gray-500 hover:bg-gray-100 w-full'>Sign up with Apple</Button>
        </div>
